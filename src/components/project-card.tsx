...
export function FlagshipCard({
  ...
  return (
    <Link
      ...
      className="group block border-t border-border py-10 transition-colors sm:py-12"
    >
      <div className="grid gap-8 md:grid-cols-12 md:items-center">
        <div className="md:col-span-7">
          ...
          <h3 className="display mt-4 text-3xl transition-colors group-hover:text-accent sm:text-4xl md:text-[2.75rem]">
            {project.title}
          </h3>
